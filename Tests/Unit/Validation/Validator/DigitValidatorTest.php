...
namespace Ydt\FrontendUser\Tests\Unit\Validation\Validator;
...
use Ydt\FrontendUser\Validation\Validator\DigitValidator;
use ReflectionClass;

/**
 * Class DigitValidatorTest
 * Testcase for class \Ydt\FrontendUser\Validation\Validator\DigitValidator
 */
class DigitValidatorTest extends UnitTestCase
{
    /**
     * Digit Validator
     *
    ...
    {
        $result = $this->subject->validate('12345a');
